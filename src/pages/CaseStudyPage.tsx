                              ...
                              <DialogContent className="max-w-lg">
                                ...
                                <div className="mt-4 space-y-4 text-sm text-gray-700">
                                  <div>
                                    ...
                                    <p>
                                      This project is a modern frontend built using React, Tailwind CSS, Vite, and shadcn/ui components.
                                    </p>
                                  </div>
                                  <div>
                                    <h3 className="font-semibold">Technologies</h3>
                                    <p>
                                      React, TypeScript, Tailwind CSS, Vite, shadcn/ui, Lucide icons.
                                    </p>
                                  </div>
                                  <div>
                                    <h3 className="font-semibold">Key Features</h3>
                                    <p>
                                      Responsive design, reusable components, fast development environment, and clean UI.
                                    </p>
                                  </div>
                                  <div>
                                    <h3 className="font-semibold">Goals</h3>
                                    <p>
                                      To deliver a polished UI experience with developer-friendly tools and scalable code structure.
                                    </p>
                                  </div>
                                </div>
                              </DialogContent>
